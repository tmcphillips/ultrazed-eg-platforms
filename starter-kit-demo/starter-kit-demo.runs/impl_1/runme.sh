...
HD_PWD='C:/Users/tmcphill/GitRepos/ultrazed-eg-platforms/starter-kit-demo/starter-kit-demo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log starter_kit_demo_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source starter_kit_demo_design_wrapper.tcl -notrace
