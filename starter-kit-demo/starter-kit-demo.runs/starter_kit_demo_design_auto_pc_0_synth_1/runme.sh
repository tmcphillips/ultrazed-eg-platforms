...
HD_PWD='C:/Users/tmcphill/GitRepos/ultrazed-eg-platforms/starter-kit-demo/starter-kit-demo.runs/starter_kit_demo_design_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log starter_kit_demo_design_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source starter_kit_demo_design_auto_pc_0.tcl
